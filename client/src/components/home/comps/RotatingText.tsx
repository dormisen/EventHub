...
// Add missing Intl.Segmenter types for TypeScript
declare global {
  interface Intl {
    Segmenter?: typeof IntlSegmenter;
  }
  // Minimal Segmenter type definition
  class IntlSegmenter {
  ...
  (
    ...
    const splitIntoCharacters = (text: string): string[] => {
      if (
        ...
        ((Intl as { Segmenter?: typeof IntlSegmenter }).Segmenter)
      ) {
        const Segmenter = (Intl as { Segmenter?: typeof IntlSegmenter }).Segmenter!;
